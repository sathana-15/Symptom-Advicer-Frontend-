...
const Register = () => {
  ...
  return (
    <div className="min-vh-100 d-flex justify-content-center align-items-center bg-light" style={{ background: '#f5f0ff' }}>
      <div className="card shadow p-4 w-100" style={{ maxWidth: '600px', borderRadius: '20px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <select className="form-select" name="roles" value={formData.roles} onChange={handleChange} required>
              ...
              <option value="ROLE_USER,ROLE_PATIENT">Patient</option>
              <option value="ROLE_USER,ROLE_DOCTOR">Doctor</option>
              <option value="ROLE_ADMIN">Admin</option>
            </select>
          </div>

          <button type="submit" className="btn w-100 fw-bold" style={{ background: '#6f42c1', color: 'white' }}>
            Register
          </button>
        </form>
      </div>
